...
test.describe(`${process.env.TEST_ENV} - guardian redirects`, () => {
  ...
  test.describe(`redirects for ${baseUrl} origin`, () => {
    test(`Verify redirect for ${baseUrl}, C1538764`, async ({ page }) => {
      ...
      const givenExpectedUrl = `${expectedBaseUrl}/en-US/products/vpn/invite/`;
  ...
  test.describe('Misc redirects', () => {
    ...
    test(`Verify redirect for ${baseUrl}/r/vpn/account, C1539671`, async ({
      ...
      const givenExpectedUrl = 'https://accounts.stage.mozaws.net/';
    ...
    test(`Verify redirect for ${baseUrl}/r/vpn/subscription, C1539672`, async ({
      ...
      const expectedUrl = 'https://accounts.stage.mozaws.net/';
  ...
  test.describe('download redirects', () => {
    ...
    test(`Verify redirect for ${baseUrl}/r/vpn/update/macos, C1539669`, async ({
      page
    }) => {
      await verifyRedirectUrl(
        page,
        `${baseUrl}/r/vpn/update/macos`,
